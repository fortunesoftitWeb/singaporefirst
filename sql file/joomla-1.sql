...
--
-- Host: localhost
-- Generation Time: Jun 23, 2015 at 04:50 PM
...
CREATE TABLE IF NOT EXISTS `qqclj_assets` (
...
INSERT INTO `qqclj_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 1, 105, 112, 1, 'com_helloworld', 'helloworld', '{}'),
(56, 55, 106, 107, 2, 'com_helloworld.message.2', 'Good bye World', '{"core.delete":{"1":1,"6":1},"core.edit":{"1":1,"6":1,"4":1}}'),
(58, 55, 108, 109, 2, 'com_helloworld.category.8', 'Hello world1', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(59, 55, 110, 111, 2, 'com_helloworld.message.3', 'Good bye Worl', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1}}');
...
CREATE TABLE IF NOT EXISTS `qqclj_associations` (
...
CREATE TABLE IF NOT EXISTS `qqclj_banners` (
...
CREATE TABLE IF NOT EXISTS `qqclj_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `qqclj_banner_tracks` (
...
CREATE TABLE IF NOT EXISTS `qqclj_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `qqclj_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
(8, 58, 1, 13, 14, 1, 'hello-world1', 'com_helloworld', 'Hello world1', 'hello-world1', '', '<p>test</p>', 1, 0, '0000-00-00 00:00:00', 6, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 298, '2015-06-22 12:17:46', 0, '0000-00-00 00:00:00', 0, '*', 1);
...
CREATE TABLE IF NOT EXISTS `qqclj_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `qqclj_content` (
...
CREATE TABLE IF NOT EXISTS `qqclj_contentitem_tag_map` (
...
CREATE TABLE IF NOT EXISTS `qqclj_content_frontpage` (
...
CREATE TABLE IF NOT EXISTS `qqclj_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `qqclj_content_types` (
...
INSERT INTO `qqclj_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
CREATE TABLE IF NOT EXISTS `qqclj_core_log_searches` (
...
CREATE TABLE IF NOT EXISTS `qqclj_extensions` (
...
INSERT INTO `qqclj_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"a600db83f756f142ef6a2a831461a0d4"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10002, 'com_helloworld', 'component', 'com_helloworld', '', 1, 1, 0, 0, '{"name":"COM_HELLOWORLD","type":"component","creationDate":"February 2015","author":"John Doe","copyright":"Copyright Info","authorEmail":"john.doe@example.org","authorUrl":"http:\\/\\/www.example.org","version":"0.0.14","description":"COM_HELLOWORLD_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 'com_helloworld', 'component', 'com_helloworld', '', 1, 1, 0, 0, '{"name":"COM_HELLOWORLD","type":"component","creationDate":"February 2015","author":"John Doe","copyright":"Copyright Info","authorEmail":"john.doe@example.org","authorUrl":"http:\\/\\/www.example.org","version":"0.0.14","description":"COM_HELLOWORLD_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10005, 'plg_content_krakenimage', 'plugin', 'prizmimage', 'content', 0, 1, 1, 0, '{"name":"plg_content_krakenimage","type":"plugin","creationDate":"March 2015","author":"Fortune Soft","copyright":"Copyright Fortune Soft \\u00a9 2015 - All rights reserved.","authorEmail":"example@example.com","authorUrl":"http:\\/\\/www.example.com","version":"1.0.1","description":"Plugin for reducing site images","group":""}', '[]', '', '', 298, '2015-06-23 10:11:49', 0, 0),
(10006, 'krakenimage', 'package', 'pkg_krakenimage', '', 0, 1, 1, 0, '{"name":"Kraken Image Optimization","type":"package","creationDate":"June 2015","author":"Fortune Soft","copyright":"Copyright Fortune Soft \\u00a9 2015 - All rights reserved.","authorEmail":"example@example.com","authorUrl":"","version":"1.0.1","description":"The Kraken Component and Plug-in for reducing images","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10007, 'com_krakenimage', 'component', 'com_krakenimage', '', 1, 1, 1, 0, '{"name":"com_krakenimage","type":"component","creationDate":"June 2015","author":"Fortune Soft","copyright":"Copyright Fortune Soft \\u00a9 2015 - All rights reserved.","authorEmail":"example@example.com","authorUrl":"http:\\/\\/www.fortunesoft.com\\/","version":"1.0.1","description":"Component for reducing site images","group":""}', '{"pi_userid":"fabcaf1d8260b3c7f8173a1da1e2eba7","pi_secretkey":"386a6a72ce9e3b4f92e6e054ce4f9dd5cb939eed","pi_totalBytesSaved":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10008, 'plg_content_krakenimage', 'plugin', 'krakenimage', 'content', 0, 1, 1, 0, '{"name":"plg_content_krakenimage","type":"plugin","creationDate":"March 2015","author":"Fortune Soft","copyright":"Copyright Fortune Soft \\u00a9 2015 - All rights reserved.","authorEmail":"example@example.com","authorUrl":"http:\\/\\/www.example.com","version":"1.0.1","description":"Plugin for reducing site images","group":""}', '[]', '', '', 0, '0000-00-00 00:00:00', 0, 0);
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_filters` (
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links` (
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms0` (
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
INSERT INTO `qqclj_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_terms` (
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
INSERT INTO `qqclj_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `qqclj_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qqclj_helloworld` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `qqclj_helloworld` (`id`, `asset_id`, `greeting`, `published`, `catid`, `params`) VALUES
(1, 0, 'Hello World!', 0, 0, ''),
(2, 56, 'Good bye World', 1, 0, '{"show_category":""}'),
(3, 59, 'Good bye Worl', 0, 0, '{"show_category":""}');
...
CREATE TABLE IF NOT EXISTS `qqclj_krakenimage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qqclj_languages` (
...
INSERT INTO `qqclj_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
CREATE TABLE IF NOT EXISTS `qqclj_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `qqclj_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(116, 'main', 'COM_HELLOWORLD_MENU', 'com-helloworld-menu', '', 'com-helloworld-menu', 'index.php?option=com_helloworld', 'component', 0, 1, 1, 10002, 0, '0000-00-00 00:00:00', 0, 6, '../media/com_helloworld/images/tux-16x16.png', 0, '', 49, 50, 0, '', 1),
(119, 'main', 'krakenImage', 'krakenimage', '', 'krakenimage', 'index.php?option=com_krakenimage', 'component', 0, 1, 1, 10007, 0, '0000-00-00 00:00:00', 0, 6, 'class:component', 0, '', 53, 54, 0, '', 1);
...
CREATE TABLE IF NOT EXISTS `qqclj_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `qqclj_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `qqclj_messages` (
...
CREATE TABLE IF NOT EXISTS `qqclj_messages_cfg` (
...
CREATE TABLE IF NOT EXISTS `qqclj_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
INSERT INTO `qqclj_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
CREATE TABLE IF NOT EXISTS `qqclj_modules_menu` (
...
INSERT INTO `qqclj_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
CREATE TABLE IF NOT EXISTS `qqclj_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qqclj_overrider` (
...
CREATE TABLE IF NOT EXISTS `qqclj_postinstall_messages` (
...
INSERT INTO `qqclj_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
CREATE TABLE IF NOT EXISTS `qqclj_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qqclj_schemas` (
...
INSERT INTO `qqclj_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.0'),
(10002, '0.0.14'),
(10003, '0.0.14'),
(10007, '1.0.1');
...
CREATE TABLE IF NOT EXISTS `qqclj_session` (
...
INSERT INTO `qqclj_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('kvp6qg4atk6atcr0ecb7veqlo6', 1, 0, '1435058009', '__default|a:8:{s:15:"session.counter";i:4;s:19:"session.timer.start";i:1435057993;s:18:"session.timer.last";i:1435058000;s:17:"session.timer.now";i:1435058001;s:22:"session.client.browser";s:74:"Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:33.0) Gecko/20100101 Firefox/33.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"298";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:29:"mahesh.nair@fortunesoftit.com";s:8:"password";s:60:"$2y$10$nSiIPjoxb8TEhu1hZpAn/.aaqjes.5Iy25RL0ty6lwwCUEcUxPZpu";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-06-12 06:33:32";s:13:"lastvisitDate";s:19:"2015-06-23 11:13:13";s:10:"activation";s:1:"0";s:6:"params";s:2:"{}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:1:{i:0;s:28:"User not Super Administrator";}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"3560ee2ed70a524d3de973e9767129a8";}', 298, 'admin');
...
CREATE TABLE IF NOT EXISTS `qqclj_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `qqclj_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
CREATE TABLE IF NOT EXISTS `qqclj_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `qqclj_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
CREATE TABLE IF NOT EXISTS `qqclj_ucm_base` (
...
CREATE TABLE IF NOT EXISTS `qqclj_ucm_content` (
...
CREATE TABLE IF NOT EXISTS `qqclj_ucm_history` (
...
CREATE TABLE IF NOT EXISTS `qqclj_updates` (
...
INSERT INTO `qqclj_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
(1, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', ''),
(2, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', ''),
(3, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.4.1', '', 'http://update.joomla.org/core/sts/extension_sts.xml', ''),
(4, 3, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/hi-IN_details.xml', ''),
(5, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', ''),
(6, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(7, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(8, 3, 0, 'Armenian', '', 'pkg_hy-AM', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/hy-AM_details.xml', ''),
(9, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(10, 3, 0, 'Malay', '', 'pkg_ms-MY', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/ms-MY_details.xml', ''),
(11, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(12, 3, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ro-RO_details.xml', ''),
(13, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(14, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', ''),
(15, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.3.0.2', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', ''),
(16, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', ''),
(17, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', ''),
(18, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', ''),
...
(21, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', ''),
(22, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', ''),
(23, 3, 0, 'EnglishCA', '', 'pkg_en-CA', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/en-CA_details.xml', ''),
(24, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', ''),
(25, 3, 0, 'FrenchCA', '', 'pkg_fr-CA', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/fr-CA_details.xml', ''),
(26, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', ''),
(27, 3, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/cy-GB_details.xml', ''),
...
(31, 3, 0, 'Dari Persian', '', 'pkg_prs-AF', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/prs-AF_details.xml', ''),
(32, 3, 0, 'EnglishUS', '', 'pkg_en-US', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', ''),
(33, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', ''),
(34, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.2.0.2', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', ''),
(35, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', ''),
(36, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', ''),
(37, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', ''),
(38, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', ''),
(39, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', ''),
(40, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', ''),
(41, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', ''),
(42, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', ''),
(43, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', ''),
(44, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', ''),
(45, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(46, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(47, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(48, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(49, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(50, 3, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/nn-NO_details.xml', ''),
(51, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', ''),
(52, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(53, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', ''),
(54, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(55, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
(56, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', ''),
(57, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', ''),
(58, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', ''),
(59, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', ''),
(60, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
...
CREATE TABLE IF NOT EXISTS `qqclj_update_sites` (
...
INSERT INTO `qqclj_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1435058003),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1435058003),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1435058003),
(4, 'WebInstaller Update Site', 'extension', 'http://appscdn.joomla.org/webapps/jedapps/webinstaller.xml', 1, 1435058001);
...
CREATE TABLE IF NOT EXISTS `qqclj_update_sites_extensions` (
...
INSERT INTO `qqclj_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 10001);
...
CREATE TABLE IF NOT EXISTS `qqclj_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
INSERT INTO `qqclj_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
CREATE TABLE IF NOT EXISTS `qqclj_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO `qqclj_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(298, 'Super User', 'admin', 'mahesh.nair@fortunesoftit.com', '$2y$10$71uPUAiWUZdlYVLGES1HaeBs.NV0bb.IO5D4pmXOS1N3VX0xsU1hO', 0, 1, '2015-06-12 06:33:32', '2015-06-23 11:13:20', '0', '{}', '0000-00-00 00:00:00', 0, '', '');
...
CREATE TABLE IF NOT EXISTS `qqclj_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qqclj_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `qqclj_user_profiles` (
...
CREATE TABLE IF NOT EXISTS `qqclj_user_usergroup_map` (
...
INSERT INTO `qqclj_user_usergroup_map` (`user_id`, `group_id`) VALUES
(298, 8);
...
CREATE TABLE IF NOT EXISTS `qqclj_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
INSERT INTO `qqclj_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
CREATE TABLE IF NOT EXISTS `qqclj_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
