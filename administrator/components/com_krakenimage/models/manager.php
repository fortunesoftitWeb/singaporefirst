...
class KrakenImageModelManager extends JModelLegacy
{
	...
	function getFolderList($base = null)
	{
		...
		$document->setTitle(JText::_('COM_KRAKENIMAGE_INSERT_IMAGE'));
	...
	function getFolderTree($base = null)
	{
		...
		$tree['data'] = (object) array('name' => JText::_('COM_KRAKENIMAGE_MEDIA'), 'relative' => '', 'absolute' => $base);
